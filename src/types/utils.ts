 ...
 */
export type ArrayWithMinLength<T, N extends number> = T[] & { length: N } & T[];
 ...
 */
export type ResultFunction<T extends (...args: any[]) => any, E extends Error = CLIError> = 
 ...
 */
export type AsyncResultFunction<T extends (...args: any[]) => any, E extends Error = CLIError> = 
  T extends (...args: infer P) => infer R
    ? (...args: P) => AsyncResult<R, E>
    : never;
 ...
 */
export function isResultSuccess<T, E extends Error>(result: Result<T, E>): result is { success: true; data: T } {
 ...
 */
export function isResultFailure<T, E extends Error>(result: Result<T, E>): result is { success: false; error: E } {
