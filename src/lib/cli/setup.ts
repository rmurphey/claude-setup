...
class SetupOrchestrator {
  private readonly languageModules: Record<string, LanguageHandler>;
   ...
   */
  async runSetupMode(config: CLIConfig, detection?: DetectionGuess): Promise<void> {
   ...
   */
  async runDevContainerMode(): Promise<void> {
    ...
    let projectTypeAnswer: { projectType: string };
   ...
   */
  async createDocumentation(config: CLIConfig): Promise<void> {
   ...
   */
  async setupLanguage(config: CLIConfig): Promise<void> {
   ...
   */
  async copyUtilityLibraries(): Promise<void> {
...
`;
   ...
   */
  async setupCICD(config: CLIConfig): Promise<void> {
   ...
   * Create initial commit
   */
  async createInitialCommit(config: CLIConfig): Promise<void> {
...
Co-Authored-By: Claude <noreply@anthropic.com>`;
   ...
   */
  async generateDevContainer(projectType: string): Promise<void> {
...
function generateClaudeTemplate(config: CLIConfig): string {
  return orchestrator.generateClaudeTemplate(config);
}

function generateActiveWorkTemplate(config: CLIConfig): string {
...
function getDevContainerConfig(projectType: string): DevContainerConfig {
