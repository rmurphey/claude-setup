...
export class SpecCompletionDetectorImpl {
    ...
    async checkSpecCompletion(specPath) {
        ...
        try {
            ...
            throw new ValidationError(`Failed to read tasks file: ${error instanceof Error ? error.message : 'Unknown error'}`, specPath, 'Check file permissions and ensure tasks.md is readable');
        }
    }
    /**
    ...
    async getAllCompletedSpecs() {
        ...
        try {
            ...
            throw new ValidationError(`Failed to scan specs directory: ${error instanceof Error ? error.message : 'Unknown error'}`, specsDir, 'Ensure .kiro/specs directory exists and is readable');
        }
