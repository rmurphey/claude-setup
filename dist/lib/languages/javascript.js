...
async function detectFramework(detection) {
    if (!detection.existingFiles.packageJson) {
        return 'vanilla';
    }
    try {
...
async function createEslintConfig(framework) {
    try {
...
async function createFrameworkEslintConfig(framework) {
...
function createFrameworkPackageJson(framework) {
...
function getFrameworkDevDeps(framework) {
