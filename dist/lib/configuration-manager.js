 ...
 */
export class ConfigurationManagerImpl {
    static CONFIG_FILE_NAME = '.kiro-archival-config.json';
    ...
    validateConfig(config) {
        try {
            ...
            const validNotificationLevels = ['none', 'minimal', 'verbose'];
    ...
    migrateConfig(oldConfig) {
        ...
        if (typeof typedConfig.notificationLevel === 'string') {
            const level = typedConfig.notificationLevel;
     ...
     */
    migrateLegacyFields(oldConfig, newConfig) {
